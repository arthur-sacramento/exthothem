...
if($lastDotIndex){
    ...
    file_put_contents($savePath, file_get_contents($search));
...
if ($search) {
    ...
    if (is_dir($directoryName)) {
        ...
        echo "<li>The specified directory does not exist.</li>";
    }
}
...
echo "</td></tr></table>";
 ...
 // Search by file contents
    ...
    if (empty($matchingFiles)) {
        ...
        echo "<br>Files that match the search term '{$search}':<br>";
        echo "<ul>";
